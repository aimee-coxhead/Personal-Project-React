  ...
  return (
    <div>
      ...
      <div class="row">
        ...
        <div class="three columns">
          <a href="http://safeshare.tv/w/gKiIPyHEcQ"><img className="image-book" src="/images/" /><h5>Giraffes Can't Dance</h5></a>
        </div>
        <div class="three columns">
          <a href="http://safeshare.tv/w/RylJZRKTSt"><img className="image-book" src="/images/" /><h5>Stellaluna</h5></a>
        </div>
        <div class="three columns">
